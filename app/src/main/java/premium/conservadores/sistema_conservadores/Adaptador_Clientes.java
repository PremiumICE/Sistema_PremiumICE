...
public class Adaptador_Clientes extends ArrayAdapter<clsClientes> {

    Context context;
    int resource, textViewResourceId;
    List<clsClientes> items, tempItems, suggestions;

    public Adaptador_Clientes(Context context, int resource, int textViewResourceId, List<clsClientes> items) {
