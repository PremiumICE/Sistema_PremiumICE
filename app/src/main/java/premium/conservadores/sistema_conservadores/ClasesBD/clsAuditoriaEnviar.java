...
public class clsAuditoriaEnviar {
    public clsAuditoriaEnviar() {

    }
    public clsAuditoriaEnviar(int Id_Conserva, int Id_Conserv, int Q, String Etiq, String Ser, int Fe_Ini, int Fe_Lim, int Nec, int Id_Che,
                              String Lat_Rev, String Long_Rev, int Id_Cli_Rev, String Img_Ev, byte[] Img_PC, int Aud) {
